...
extra = attributes / pseudo / pseudoSpecial / pseudoSpecialO / pseudoPlacebo / multi / child / ichild / after / contains / brackets
attributes = class / id
...
pseudoPlacebo = ":" p:("text") "(" v:[^\)]* ")" extra:extra? {var a={};a.pseudo=p;a.value=v.join("");a.extra=extra||{};return a}
